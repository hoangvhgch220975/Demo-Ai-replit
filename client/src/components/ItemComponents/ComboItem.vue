<template>
    <div class="combo-page">
      <div class="product-scroll-container">
        ...
        <!-- Loop through the combos and display each combo card -->
        <div
  ...
  export default {
    ...
    methods: {
      ...
      scrollRight() {
        if (this.scrollPosition + 3 < this.combos.length) {
          this.scrollPosition += 1;
        }
      },
      goToComboDetail(comboId) {
        this.$router.push(`/combos/${comboId}`);
      },
    },
  };
  </script>
